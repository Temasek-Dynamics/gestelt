...
alias catkin_make_release="catkin_make -DCMAKE_BUILD_TYPE=Release -DCATKIN_BLACKLIST_PACKAGES="rviz_plugins;manual_take_over;odom_visualization;pose_utils;uav_utils;drone_detect"" -j3 -l3
```
