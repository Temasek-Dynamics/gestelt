 ...
 * @param closed_list 
 */
void publishVizCubes(const std::vector<Eigen::Vector3d>& closed_list, const std::string& frame_id, ros::Publisher& publisher) {
 ...
 * @param path 
 */
void publishVizSpheres(const std::vector<Eigen::Vector3d>& pts, const std::string& frame_id, ros::Publisher& publisher) {
