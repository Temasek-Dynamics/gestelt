...
DEST_HOST="10.246.80.39"             # Destination host (IP or domain)
...
rsync -avz yanrui@$DEST_HOST:/home/yanrui/storage/perceptive_diff_drone/logs/$FOLDER_NAME/$1 /home/yanrui/storage/gestelt_ws/src/gestelt/gestelt_navigation/nn_policy/logs/cmdp
