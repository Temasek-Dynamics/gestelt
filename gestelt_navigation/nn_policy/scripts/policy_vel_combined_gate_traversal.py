...
class TEST_RENDER(object):
    ...
    def __init__(self, policy_path, pc, warp_frame, use_gru=False, include_actions=False, include_gate_ori=False):
        self.pc = pc
        ...
        ## Loading Policy
        input_dims = 20 if include_gate_ori else 16
        print(f"Policy input_dims: {input_dims} (include_gate_ori={include_gate_ori})")
        if self.pc == True:
            if use_gru == False:
