...
class DeterministicForest
{
	public:
		...
		DeterministicForest(ros::NodeHandle &nodeHandle) : nh_(nodeHandle)
		{
			...
			cylinders.push_back(Cylinder(a-0.4, 0.0, 0.225, 3.0)); // Left obstacle
			cylinders.push_back(Cylinder(0.0, -a, 0.225, 3.0));		// Top obstacle
			cylinders.push_back(Cylinder(-a+0.4, 0.0, 0.225, 3.0)); // Right obstacle
			cylinders.push_back(Cylinder(0.0, a, 0.225, 3.0));		// Bottom obstacle
			cylinders.push_back(Cylinder(0.2, 0.0, 0.225, 3.0));	// Center obstacle
