...
from Learning_Agile.config import mission_cfg,train_cfg,current_dir,setup_training_directories, get_time_name
from Learning_Agile.logger_misc import log_drone_state_wandb,log_train_IO_wandb,log_gradient_wandb
...
class LearningAgileAPG:
    ...
    def init_train(self,model_folder,checkpoint_trained_model_folder):
        ...
        if options['TRAIN_FROM_CHECKPOINT'] or options['STATE_2_MOVING_GATE']:
            FILE = os.path.join(checkpoint_trained_model_folder, "new_format/2025-06-09/12-15-32/trained_model/NN_close_280.pth")
