...
if __name__ == "__main__":
    ...
    training_results_dir = "/home/tlab-uav/gestelt_ws/src/gestelt/gestelt_bringup/src/Learning_Agile/training_results"
    model_path = training_results_dir+"/pretrain_model/NN_close_pretrain.pth"
    output_dir = os.path.join(training_results_dir,"pretrain_model")
