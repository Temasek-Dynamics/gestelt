...
/* ACADOS_model_impl_dae_fun_jac_x_xdot_u_z:(i0[13],i1[13],i2[4],i3[],i4[],i5[30])->(o0[13],o1[13x13,43nz],o2[13x13,13nz],o3[13x4,6nz],o4[13x0]) */
...
CASADI_SYMBOL_EXPORT int ACADOS_model_impl_dae_fun_jac_x_xdot_u_z_work_bytes(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
