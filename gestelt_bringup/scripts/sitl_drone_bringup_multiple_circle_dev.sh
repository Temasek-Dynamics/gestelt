...
CMD_0="
roslaunch gestelt_bringup sitl_drone.launch rviz_config:=gz_sim_gate
"

# Start up drone commander (Handles taking off, execution of mission and landing etc.)
CMD_1="
roslaunch trajectory_server trajectory_server_node.launch 
"
...
CMD_3="roslaunch gestelt_bringup multiple_circle_mission_dev.launch"
