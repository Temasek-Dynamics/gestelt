...
CMD_1="
roslaunch --wait gestelt_bringup back_end_planner.launch drone_id:=0
"

# Start up central bridge and nodes
CMD_2="
roslaunch --wait gestelt_bringup fake_map_central.launch rviz_config:=bubble
"

# Start up script to send commands
CMD_3="roslaunch --wait gestelt_bringup mission_bubble_planner_test.launch"
