...
RECORD=true
DATA_DIR="$SCRIPT_DIR/../../../gestelt/gestelt_bringup/data"
...
CMD_1="roslaunch trajectory_server trajectory_server_node.launch"



# Start up script to send commands
CMD_2="taskset -c 1 roslaunch gestelt_bringup learning_agile_mission.launch platform:='laptop'"
