...
//  private int simDelayMax = 500;  // Max delay between simulated and real time to skip samples in simulator, in ms
    ...
    private AbstractMulticopter buildMulticopter() {
        ...
        AbstractMulticopter vehicle = new Quadcopter(world, vehicle_model, "x", "default", 0.0755, 3.8635*0.8,
                                                     0.0625, 0.02, gc, SHOW_GUI);
    ...
    private AbstractMulticopter buildAQ_leora() {
        ...
        //AbstractMulticopter vehicle = new Quadcopter(world, vehicle_model, "x", "cw_fr", 0.0755, 3.8635,
        //                                             0.0625, 0.02, gc, SHOW_GUI);
